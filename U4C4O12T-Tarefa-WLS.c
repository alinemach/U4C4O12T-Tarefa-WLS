...
#include "U4C4O12T_Tarefa_WLS.pio.h"

// Definições de pinos
#define LED_RED 13
#define LED_U4C4O12T_Tarefa_WLS 7
#define BUTTON_A 5
#define BUTTON_B 6
...
// Buffer da matriz U4C4O12T_Tarefa_WLS
...
int main() {
    ...
    // Inicialização da matriz U4C4O12T_Tarefa_WLS
    int offset = pio_add_program(pio, &U4C4O12T_Tarefa_WLS_program);
    U4C4O12T_Tarefa_WLS_program_init(pio, sm, offset, LED_U4C4O12T_Tarefa_WLS, 800000, false);
